...
### App Description
User Questions and Answers are now stored and can be accessed even if the user restart the app. Moreover, users can move between cards and delete them.

### App Walk-though
<img src="https://github.com/ayahia1/Android--QA/blob/master/Walkthrough-3.gif" width=200><br>
